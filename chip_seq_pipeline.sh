...
echo "heatmap for G1E signal score distributions accros TAL1 peak genomic regions"
plotHeatmap -m results/G1E_matrix_macs3_bigwig.gz \
  -out results/G1E_TAL1_heatmap.png \
  --samplesLabel "G1E_TAL1_R1" "G1E_TAL1_R2" \
  --colorMap RdBu \
  --sortRegions descend \
  --plotTitle "TAL1 Peak Distribution in G1E Cells" 
